...
const styles = {
    ...
    input: `w-full bg-[#323546] p-4 outline-none rounded-xl mt-4`,
    chatContainer: `p-5 bg-[#222531] rounded-xl max-h-full`,
    flexBetween: `flex justify-between`,
    flexCenter: `flex justify-center items-center`,
    chat: `max-w-lg min-w-full`,
    postButtonContainer: `flex align-center justify-end mt-4`,
    boldText: `font-bold`,
                ...
                <div className={styles.chatContainer}>
                    <div className={styles.flexBetween}>
                        <div className={styles.flexCenter}>
                            <div>
                                <Image alt='' className="rounded-full px-10" src={'https://avatars.githubusercontent.com/u/38469892?v=4'} width={70} height={70} />
                            </div>
                            <div className='text-left mr-10 pl-5'>
                                <b>Rookas</b>
                                <p className='text-gray-400'>@rokasrudzianskas</p>
                            </div>
                        </div>
